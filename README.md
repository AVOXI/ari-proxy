...
Binary releases are available on the [releases page](https://github.com/AVOXI/ari-proxy/releases).
...
`github.com/AVOXI/ari-proxy/client` package, and your dependency management
